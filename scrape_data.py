...
# Scrape de prijs van een specifiek product op een specifieke url
...
# Verwerk resultaten door ze naar een bestand te schrijven
...
# Klik filters voor het merk van de kaart aan met selenium, wacht tussendoor om errors te voorkomen
time.sleep(1)
...
# Deze functie scrapet de prijzen en namen van alle producten op megekko
def scrape_pagina(next_page_xpath, naam_toevoeging =""):
    # Loep voor de hoeveelheid pagina's
    for i in range(hoeveelheid + 1):
        ...
        if producten_container == []:
            # Vind de naam op een andere plek
...
verwerk_resultaten("data/scraped_data/scraped_gpus.txt", producten, prijzen)
...
verwerk_resultaten("data/scraped_data/scraped_psus.txt", producten, prijzen)
...
verwerk_resultaten("data/scraped_data/scraped_cpus.txt", producten, prijzen)
...
# Scrape pagina en verwerk resultaten
scrape_pagina('//*[@id="navigation_products"]/div[5]/div[3]')
verwerk_resultaten("data/scraped_data/scraped_moederborden.txt", producten, prijzen)
...
verwerk_resultaten("data/results_data/results_coolers.txt", producten, prijzen)
...
time.sleep(1)
producten.append(driver.find_element(By.XPATH, '//*[@id="content_list_content"]/div[1]/div/div[2]/a/h2').text)
prijzen.append((driver.find_element(By.XPATH, '//*[@id="content_list_content"]/div[1]/div/div[2]/div[4]/div/div/a/div/div[1]').text).strip(','))
# Zalman t7
...
verwerk_resultaten("data/results_data/results_behuizing.txt", producten, prijzen)
...
hoeveelheid = bereken_hoeveelheid()
scrape_pagina('//*[@id="navigation_products"]/div[5]/div[3]')
verwerk_resultaten("data/scraped_data/scraped_opslag.txt", producten, prijzen)
...
hoeveelheid = bereken_hoeveelheid()
scrape_pagina('//*[@id="navigation_products"]/div[5]/div[3]')
verwerk_resultaten("data/scraped_data/scraped_ram_ddr4.txt", producten, prijzen)
...
hoeveelheid = bereken_hoeveelheid()
scrape_pagina('//*[@id="navigation_products"]/div[5]/div[3]')
verwerk_resultaten("data/scraped_data/scraped_ram_ddr5.txt", producten, prijzen)